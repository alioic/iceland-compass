"""Iceland Compass — Pinterest pin generator, LOTA 2 (10 nýir pinnar).

Sama útlit og make_pins.py: 1000x1500, heil mynd + dökkur halli + hvítt logo efst,
kicker + Fraunces-titill neðst + icelandcompass.com.

Keyrsla:  python3 scratchpad/make_pins2.py
Úttak:    scratchpad/pins2/<slug>.png
"""
import os
...
OUT   = os.path.join(ROOT, "scratchpad/pins2")
...
def make_pin(image_key, kicker, title, slug):
    ...
    # logo efst: fjalla-emblem + "ICELAND / COMPASS" (Fraunces, hvítt, staflað)
...
# (mynd, kicker, titill, slug/skráarnafn)
BATCH=[
 ("akstur-a-islandi","Driving","Renting a Car & Driving in Iceland","akstur-a-islandi"),
 ("hvenaer-fara","When to Go","The Best Time to Visit Iceland","hvenaer-fara"),
 ("island-ad-vetri","Winter","Iceland in Winter: An Honest Guide","island-ad-vetri"),
 ("fyrsta-ferdin","First Trip","First Time in Iceland: What to Know","fyrsta-ferdin"),
 ("kaupa-lopapeysu","Icelandic Wool","Where to Buy a Real Icelandic Sweater","kaupa-lopapeysu"),
 ("islensk-brugghus","Craft Beer","Iceland's Best Craft Breweries","islensk-brugghus"),
 ("beint-fra-byli","Local Food","Farm Shops & Local Food in Iceland","beint-fra-byli"),
 ("vestfirdir","Westfjords","The Westfjords: Iceland's Wild Secret","vestfirdir"),
 ("landmannalaugar","Highlands","Landmannalaugar: Iceland's Rainbow Mountains","landmannalaugar"),
 ("jokulsarlon","Glacier Lagoon","Jökulsárlón: Iceland's Glacier Lagoon","jokulsarlon"),
]
